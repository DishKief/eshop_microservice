...
const Signup = () => {
  ...
  const signupMutation = useMutation({
    mutationFn: async (data: FormData) => {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_SERVER_URI}/api/v1/seller-registration`,
        data,
      );
  ...
  const verifyOtpMutation = useMutation({
    mutationFn: async () => {
      ...
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_SERVER_URI}/api/v1/verify-seller`,
        {
          ...sellerData,
          otp: otpSent.join(""),
        },
  ...
  const connectStripe = async () => {
    // window.location.href = `${process.env.NEXT_PUBLIC_SERVER_URI}/api/v1/connect-stripe?sellerId=${sellerId}`;
    try {
      const response = await axios.post(
        `${process.env.NEXT_PUBLIC_SERVER_URI}/api/v1/create-stripe-link`,
        { sellerId },
      );
